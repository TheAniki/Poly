...
void TransmissionChaineUART::initialisationUART (void) {
    UBRR0H = 0;
    UBRR0L = 0xCF;
...
void TransmissionChaineUART::transmissionUART (uint16_t donnee) {
...
void TransmissionChaineUART::afficherChaine() {
...
uint8_t TransmissionChaineUART::USART_Receive()
{
    while(!(UCSR0A & (1<<RXC0))){}
    return UDR0;
}
